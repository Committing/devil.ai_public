...
class logic_calculation_data
{
    ...
    public static $most_compatible = array(
        'INTP' => array(
            ...
            'stack_compatibility' => array('ENTJ', 'INTJ', 'ESFP', 'ISFP', 'ENFJ', 'INFJ', 'ESTP', 'ISTP', 'ESTJ', 'ISTJ', 'ENFP', 'INFP', 'ESFJ', 'ISFJ', 'ENTP', 'INTP'),
        ...
        'ENTP' => array(
            'duo_compatibility'   => array('NJ', 'SP', 'NP', 'SJ'),
            'tri_compatibility'   => array('NTJ', 'SFP', 'NFJ', 'STP', 'STJ', 'NFP', 'SFJ', 'NTP'),
            'stack_compatibility' => array('INTJ', 'ENTJ', 'ISFP', 'ESFP', 'INFJ', 'ENFJ', 'ISTP', 'ESTP', 'ISTJ', 'ESTJ', 'INFP', 'ENFP', 'ISFJ', 'ESFJ', 'INTP', 'ENTP'),
            'meta_compatibility'  => array('ISFJ')
        ),
        'ISFJ' => array(
            'duo_compatibility'   => array('SP', 'NJ', 'SJ', 'NP'),
            'tri_compatibility'   => array('SFP', 'NTJ', 'STP', 'NFJ', 'NFP', 'STJ', 'NTP', 'SFJ'),
            'stack_compatibility' => array('ESFP', 'ISFP', 'ENTJ', 'INTJ', 'ESTP', 'ISTP', 'ENFJ', 'INFJ', 'ENFP', 'INFP', 'ESTJ', 'ISTJ', 'ENTP', 'INTP', 'ESFJ', 'ISFJ'),
            'meta_compatibility'  => array('ENTP')
        ),
        'ESFJ' => array(
            'duo_compatibility'   => array('SP', 'NJ', 'SJ', 'NP'),
            'tri_compatibility'   => array('SFP', 'NTJ', 'STP', 'NFJ', 'NFP', 'STJ', 'NTP', 'SFJ'),
            'stack_compatibility' => array('ISFP', 'ESFP', 'INTJ', 'ENTJ', 'ISTP', 'ESTP', 'INFJ', 'ENFJ', 'INFP', 'ENFP', 'ISTJ', 'ESTJ', 'INTP', 'ENTP', 'ISFJ', 'ESFJ'),
            'meta_compatibility'  => array('INTP')
        ),
        'ENTJ' => array(
            'duo_compatibility'   => array('NP', 'SJ', 'NJ', 'SP'),
            'tri_compatibility'   => array('NTP', 'SFJ', 'NFP', 'STJ', 'STP', 'NFJ', 'SFP', 'NTJ'),
            'stack_compatibility' => array('INTP', 'ENTP', 'ISFJ', 'ESFJ', 'INFP', 'ENFP', 'ISTJ', 'ESTJ', 'ISTP', 'ESTP', 'INFJ', 'ENFJ', 'ISFP', 'ESFP', 'INTJ', 'ENTJ'),
            'meta_compatibility'  => array('ISFP')
        ),
        'INTJ' => array(
            'duo_compatibility'   => array('NP', 'SJ', 'NJ', 'SP'),
            'tri_compatibility'   => array('NTP', 'SFJ', 'NFP', 'STJ', 'STP', 'NFJ', 'SFP', 'NTJ'),
            'stack_compatibility' => array('ENTP', 'INTP', 'ESFJ', 'ISFJ', 'ENFP', 'INFP', 'ESTJ', 'ISTJ', 'ESTP', 'ISTP', 'ENFJ', 'INFJ', 'ESFP', 'ISFP', 'ENTJ', 'INTJ'),
            'meta_compatibility'  => array('ESFP')
        ),
        'ESFP' => array(
            'duo_compatibility'   => array('SJ', 'NP', 'SP', 'NJ'),
            'tri_compatibility'   => array('SFJ', 'NTP', 'STJ', 'NFP', 'NFJ', 'STP', 'NTJ', 'SFP'),
            'stack_compatibility' => array('ISFJ', 'ESFJ', 'INTP', 'ENTP', 'ISTJ', 'ESTJ', 'INFP', 'ENFP', 'INFJ', 'ENFJ', 'ISTP', 'ESTP', 'INTJ', 'ENTJ', 'ISFP', 'ESFP'),
            'meta_compatibility'  => array('INTJ')
        ),
        'ISFP' => array(
            'duo_compatibility'   => array('SJ', 'NP', 'SP', 'NJ'),
            'tri_compatibility'   => array('SFJ', 'NTP', 'STJ', 'NFP', 'NFJ', 'STP', 'NTJ', 'SFP'),
            'stack_compatibility' => array('ESFJ', 'ISFJ', 'ENTP', 'INTP', 'ESTJ', 'ISTJ', 'ENFP', 'INFP', 'ENFJ', 'INFJ', 'ESTP', 'ISTP', 'ENTJ', 'INTJ', 'ESFP', 'ISFP'),
            'meta_compatibility'  => array('ENTJ')
        ),
        'ISTP' => array(
            'duo_compatibility'   => array('SJ', 'NP', 'SP', 'NJ'),
            'tri_compatibility'   => array('STJ', 'NFP', 'SFJ', 'NTP', 'NTJ', 'SFP', 'NFJ', 'STP'),
            'stack_compatibility' => array('ESTJ', 'ISTJ', 'ENFP', 'INFP', 'ESFJ', 'ISFJ', 'ENTP', 'INTP', 'ENTJ', 'INTJ', 'ESFP', 'ISFP', 'ENFJ', 'INFJ', 'ESTP', 'ISTP'),
            'meta_compatibility'  => array('ENFJ')
        ),
        'ESTP' => array(
            'duo_compatibility'   => array('SJ', 'NP', 'SP', 'NJ'),
            'tri_compatibility'   => array('STJ', 'NFP', 'SFJ', 'NTP', 'NTJ', 'SFP', 'NFJ', 'STP'),
            'stack_compatibility' => array('ISTJ', 'ESTJ', 'INFP', 'ENFP', 'ISFJ', 'ESFJ', 'INTP', 'ENTP', 'INTJ', 'ENTJ', 'ISFP', 'ESFP', 'INFJ', 'ENFJ', 'ISTP', 'ESTP'),
            'meta_compatibility'  => array('INFJ')
        ),
        'INFJ' => array(
            'duo_compatibility'   => array('NP', 'SJ', 'NJ', 'SP'),
            'tri_compatibility'   => array('NFP', 'STJ', 'NTP', 'SFJ', 'SFP', 'NTJ', 'STP', 'NFJ'),
            'stack_compatibility' => array('ENFP', 'INFP', 'ESTJ', 'ISTJ', 'ENTP', 'INTP', 'ESFJ', 'ISFJ', 'ESFP', 'ISFP', 'ENTJ', 'INTJ', 'ESTP', 'ISTP', 'ENFJ', 'INFJ'),
        ...
        'ENFJ' => array(
            'duo_compatibility'   => array('NP', 'SJ', 'NJ', 'SP'),
            'tri_compatibility'   => array('NFP', 'STJ', 'NTP', 'SFJ', 'SFP', 'NTJ', 'STP', 'NFJ'),
            'stack_compatibility' => array('INFP', 'ENFP', 'ISTJ', 'ESTJ', 'INTP', 'ENTP', 'ISFJ', 'ESFJ', 'ISFP', 'ESFP', 'INTJ', 'ENTJ', 'ISTP', 'ESTP', 'INFJ', 'ENFJ'),
            'meta_compatibility'  => array('ISTP')
        ),
        'ESTJ' => array(
            'duo_compatibility'   => array('SP', 'NJ', 'SJ', 'NP'),
            'tri_compatibility'   => array('STP', 'NFJ', 'SFP', 'NTJ', 'NTP', 'SFJ', 'NFP', 'STJ'),
            'stack_compatibility' => array('ISTP', 'ESTP', 'INFJ', 'ENFJ', 'ISFP', 'ESFP', 'INTJ', 'ENTJ', 'INTP', 'ENTP', 'ISFJ', 'ESFJ', 'INFP', 'ENFP', 'ISTJ', 'ESTJ'),
            'meta_compatibility'  => array('INFP')
        ),
        'ISTJ' => array(
            'duo_compatibility'   => array('SP', 'NJ', 'SJ', 'NP'),
            'tri_compatibility'   => array('STP', 'NFJ', 'SFP', 'NTJ', 'NTP', 'SFJ', 'NFP', 'STJ'),
            'stack_compatibility' => array('ESTP', 'ISTP', 'ENFJ', 'INFJ', 'ESFP', 'ISFP', 'ENTJ', 'INTJ', 'ENTP', 'INTP', 'ESFJ', 'ISFJ', 'ENFP', 'INFP', 'ESTJ', 'ISTJ'),
            'meta_compatibility'  => array('ENFP')
        ),
        'ENFP' => array(
            'duo_compatibility'   => array('NJ', 'SP', 'NP', 'SJ'),
            'tri_compatibility'   => array('NFJ', 'STP', 'NTJ', 'SFP', 'SFJ', 'NTP', 'STJ', 'NFP'),
            'stack_compatibility' => array('INFJ', 'ENFJ', 'ISTP', 'ESTP', 'INTJ', 'ENTJ', 'ISFP', 'ESFP', 'ISFJ', 'ESFJ', 'INTP', 'ENTP', 'ISTJ', 'ESTJ', 'INFP', 'ENFP'),
            'meta_compatibility'  => array('ISTJ')
        ),
        'INFP' => array(
            'duo_compatibility'   => array('NJ', 'SP', 'NP', 'SJ'),
            'tri_compatibility'   => array('NFJ', 'STP', 'NTJ', 'SFP', 'SFJ', 'NTP', 'STJ', 'NFP'),
            'stack_compatibility' => array('ENFJ', 'INFJ', 'ESTP', 'ISTP', 'ENTJ', 'INTJ', 'ESFP', 'ISFP', 'ESFJ', 'ISFJ', 'ENTP', 'INTP', 'ESTJ', 'ISTJ', 'ENFP', 'INFP'),
